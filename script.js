document.addEventListener('DOMContentLoaded', () => {
    ...
    const closeModal = () => {
        ...
        modal.querySelector('img').src = ''; // Clear image source
        modal.querySelector('.caption').innerText = ''; // Clear caption
        modal.querySelector('p').innerText = ''; // Clear description
    };
    ...
    const showModal = (index) => {
        ...
        modal.querySelector('.caption').innerText = imageData.caption;
